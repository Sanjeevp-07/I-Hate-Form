    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">I Hate Form</h1>
          <p className="text-xs text-slate-500 font-medium">Sign in to sync your profile with the Chrome Extension</p>
        </div>
        ...
        <div className="p-6 bg-white border border-slate-200 rounded-3xl shadow-sm space-y-5">
          ...
          <div className="pt-4 border-t border-slate-100 text-center text-xs text-slate-500 font-medium">
            ...
            <Link href="/signup" className="text-[#0066FF] hover:underline font-bold">
              Create an account
            </Link>
          </div>
        </div>
